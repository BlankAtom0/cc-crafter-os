...
local function main()
    ...
    if fs.exists("client/config") then
        print("Config file already exists.")
        return
    else
        local configFile = io.open("client/config", "w")
    ...
    shell.run("pastebin get", updaterpastebin, "updater.lua")
